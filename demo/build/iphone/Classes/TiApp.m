...
- (void)boot
{
	DebugLog(@"[INFO] %@/%@ (%s.021f705)",TI_APPLICATION_NAME,TI_APPLICATION_VERSION,TI_VERSION_STR);
...
- (NSString*)userAgent
{
	if (userAgent==nil)
	{
		...
		userAgent = [[NSString stringWithFormat:@"%@/%s (%@)",ktestUserAgentPrefix,TI_VERSION_STR,currentDeviceInfo] retain];
	}
	return userAgent;
}
